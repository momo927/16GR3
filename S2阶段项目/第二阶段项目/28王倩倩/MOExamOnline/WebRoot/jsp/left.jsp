...
<script type="text/javascript">
        ...
        function setMangerMenu() {
             ...
             outlookbar.additem('题库管理', t, '../question/question_getCourseInfo'); 
     		 outlookbar.additem('试卷管理', t, 'paperManage.jsp');
             outlookbar.additem('成绩管理', t, '../jsp/developing.jsp');
             outlookbar.additem('修改密码', t, '../jsp/developing.jsp');

             t = outlookbar.addtitle('基本设置', '后台管理', 2);
             outlookbar.additem('专业设置', t, '../jsp/developing.jsp');
             outlookbar.additem('设置学费', t, '../jsp/developing.jsp');
             outlookbar.additem('科目管理', t, '../jsp/developing.jsp');
             outlookbar.additem('宿舍管理', t, '../jsp/developing.jsp');
		}
