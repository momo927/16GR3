...
<body>
	<div class="menu">
		<form method="get" action="account?cmd=getAccountByParam">
		...
		<div class="content">
			<table class="list">
				...
				<tr>
					...
					<td>
					<a href="provider?cmd=getAllProvider && action=update&&accountId=${accountdetail.accountId }">修改</a><br>
					<a href="provider?cmd=getAllProvider && action=delect&&accountId=${accountdetail.accountId }">删除</a><br>
					</td>
				</tr>
				</c:forEach>
			</table>
		</div>
		<form id="form" action="account?cmd=getPageBean" method="post">
