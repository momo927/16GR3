package com.qhit.lh.gr3.momo.exam.bjgl.bean;

import java.util.Date;
import java.util.HashSet;
import java.util.Set;

import com.qhit.lh.gr3.momo.exam.common.bean.Student;
...
public class ClassInfo implements java.io.Serializable {
	...
	/** minimal constructor */
	public ClassInfo(String ccode, String cname, String major, Integer insId, Integer iecId, Date cdate) {
		this.ccode = ccode;
		this.cname = cname;
		this.major = major;
		this.insId = insId;
	...
	/** full constructor */
	public ClassInfo(String ccode, String cname, String major, Integer insId, Integer iecId, Date cdate, Integer g1num,
			Integer g2num, Integer g3num, Integer csId, String cremark) {
		this.ccode = ccode;
		this.cname = cname;
		this.major = major;
		this.insId = insId;
